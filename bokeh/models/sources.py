...
class ColumnDataSource(ColumnarDataSource):
    ...
    * A Pandas ``GroupBy`` object
    ...
    def multi_stream(self, new_data, rollover=None):
        ...
        self._multi_stream(new_data, rollover)

    def _multi_stream(self, new_data, rollover=None, setter=None):
        ...
        if newkeys != oldkeys:
            ...
            if extra:
                raise ValueError("Must stream updates to existing columns (extra: %s)" % ", ".join(sorted(extra)))
